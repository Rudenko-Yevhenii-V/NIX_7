    ...
    public LevelTwo() {
        ...
        if (System.getProperty("os.name").contains("W")) {
            iconTitle = new ImageIcon(
                    getClass().getClassLoader().getResource("images/titl2.jpg"));
            iconTitle.getImage().flush();
            titleLabel = new JLabel();
            titleLabel.setIcon(iconTitle);

            icon2 = new ImageIcon(
                    getClass().getClassLoader().getResource("images/task1lvl2.jpg"));
            icon2.getImage().flush();
            task2Label = new JLabel();
            task2Label.setIcon(icon2);
            icon3 = new ImageIcon(
                    getClass().getClassLoader().getResource("images/task2lvl2.jpg"));
