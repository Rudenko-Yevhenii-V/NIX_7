    ...
    public LevelOne() {
        ...
        if (System.getProperty("os.name").contains("W")) {
            iconTitle = new ImageIcon(
                    getClass().getClassLoader().getResource("images/lvl1title.jpg"));
            iconTitle.getImage().flush();
            titleLabel = new JLabel();
            titleLabel.setIcon(iconTitle);
            icon1 = new ImageIcon(
                    getClass().getClassLoader().getResource("images/lvl1t1.jpg"));
            icon1.getImage().flush();
            task1Label = new JLabel();
            task1Label.setIcon(icon1);
            icon2 = new ImageIcon(
                    getClass().getClassLoader().getResource("images/lvl1t2.jpg"));
            icon2.getImage().flush();
            task2Label = new JLabel();
            task2Label.setIcon(icon2);
            icon3 = new ImageIcon(
                    getClass().getClassLoader().getResource("images/lvl1t3.jpg"));
