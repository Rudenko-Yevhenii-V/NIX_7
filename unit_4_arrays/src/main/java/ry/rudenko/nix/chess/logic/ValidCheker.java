...
public class ValidCheker {
  ...
  public boolean moveValid() {
    if (figure1.toString().equals("empty")) {
      System.err.println("EMPTY place! Choise figure!");
      return false;
    }
    ...
    //todo
    if (!figure1.isMoveValid(nowRow, nowCol, needRow, needCol, figures)) {
      System.out.println("This piece doesn't move like that");
      return false;
    }
    if (figure2.toString().equals("empty")) {
      return true;
    }
